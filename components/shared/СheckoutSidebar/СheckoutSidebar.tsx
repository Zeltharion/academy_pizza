...
export const CheckoutSidebar: React.FC<ICheckoutSidebar> = ({ className, totalAmount }) => {
	...
	return (
		<WhiteBlock className={cn(s.checkoutSidebar, className)}>
			<div className={s.checkoutSidebar__total}>
				...
				<span className={s.checkoutSidebar__total__price}>{totalPrice} ₽</span>
			</div>
			...
			<Button type="submit" className={s.checkoutSidebar__button}>
				Перейти к оплате
